...
function displayCartItems() {
 ...
 const shippingCost = 30.00;
  ...
  if (cart.length === 0) {
    itemListContainer.innerHTML += `<div class="cart3"><h1 class="cart1">Your cart is empty.</h1>
    <button id="cart2">Continue Shopping </button></div>`;
    const contain = document.getElementById('col')
    const call = document.getElementById('cart2')
